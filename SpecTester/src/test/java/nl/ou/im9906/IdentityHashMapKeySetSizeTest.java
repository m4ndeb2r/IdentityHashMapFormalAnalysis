...
/**
 * Tests the JML specifications of the {@link VerifiedIdentityHashMap.KeySet#size()} method.
 *
 * Note: the size method of the {@link VerifiedIdentityHashMap.KeySet} is not verfified with KeY.
