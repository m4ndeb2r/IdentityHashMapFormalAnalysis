...
/**
 * Tests the JML specifications of the {@link VerifiedIdentityHashMap.Values#contains(Object)} method.
 *
 * Note: the contains method of the {@link VerifiedIdentityHashMap.Values} is not verfified with KeY.
 * The JML may, therefore, still be incomplete or incorrect. So may this test.
 */
public class IdentityHashMapValuesContainsTest {

    /**
     * Tests the normal behaviour of the method {@link VerifiedIdentityHashMap.Values#size()}.
    ...
    public void testValuesContainsNormalBehaviour()
        ...
        // TODO: this only tests the fields of the VerifiedIdentityHashMap.Values class, not the
