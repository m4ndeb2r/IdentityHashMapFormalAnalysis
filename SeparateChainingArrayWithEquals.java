...
public class SeparateChainingArrayWithEquals {
	...
	public SeparateChainingArrayWithEquals(int chains) {
		...
		pairs = 0;
		this.chains = chains;
		HashObject[][] keysTemp = new HashObject[chains][];
		...
		/*@ loop_invariant	0 <= j && j <= chains &&
		  ...
		  @						&& \typeof(keysTemp[x]) == \type(HashObject[])
	...
	/*@ public normal_behavior
	  ...
	  @ helper
	  @*/
	private /*@ nullable @*/ HashObject[] increaseAndCopyKeys(/*@ nullable @*/ HashObject[] array, HashObject element) {
