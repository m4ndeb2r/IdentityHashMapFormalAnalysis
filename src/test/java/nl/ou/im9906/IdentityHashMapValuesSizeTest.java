...
/**
 * Tests the JML specifications of the {@link VerifiedIdentityHashMap.Values#size()} method.
 *
 * Note: the size method of the {@link VerifiedIdentityHashMap.Values} is not verfified with KeY.
